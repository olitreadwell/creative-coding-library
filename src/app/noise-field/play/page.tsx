...
export default function NoiseFieldPlayPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-foreground flex flex-col">
      ...
      <header className="px-4 py-3 flex flex-wrap items-center gap-x-4 gap-y-2 justify-between border-b border-white/10 shrink-0">
        ...
        <h1 className="text-sm font-medium tracking-wide text-white/90">Noise Field — Live</h1>
        <button
          type="button"
          onClick={handleNewSeed}
          className="text-sm px-3 py-1 rounded border border-white/30 hover:border-white/60
      ...
      {/* Dark art stage: kept dark for additive-glow to work correctly. */}
      ...
      <footer className="px-4 py-3 text-xs text-white/70 border-t border-white/10 shrink-0">
